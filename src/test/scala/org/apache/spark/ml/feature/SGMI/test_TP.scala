...
class test_TP extends BasicSparkTest {

  test(testName = "SGMI_TP-Synthetic") {

    val spark = createSession("SGMI_TP-Synthetic")
  ...
  test(testName = "SGMI-TP-Musk") {

    val spark = createSession("SGMI-TP-Musk")
  ...
  test(testName = "SGMI-TP-Alpha") {

    val spark = createSession("SGMI-TP-Alpha")
